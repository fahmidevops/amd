...
class Post extends Model
{
    ...
    // protected $fillable = ['title', 'excerpt', 'body'];  //field yang boleh diisi di definisikan), $guarded adalah field apa saja yg tidak boleh di isi
    ...
    {
        return $this->belongsTo(User::class, 'user_id'); //foreignkey user_id dialiaskan menjadi author
    }
