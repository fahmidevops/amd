...
@section('container')
    ...
    <div class="row justify-content-center mb-3">
        <div class="col-md-6">
            {{-- <form action="/posts" method="GET"> tidak perlu menambahkan method get karena default form action adalah get --}}
            <form action="/posts"> 
                @if (request('category')) {{-- kalau ada request category di url  --}}
    ...
    {{-- merubahnya menjadi flexbox dan pengaturan mulai dari kiri justify-content-start justify-content-center justify-content-end --}}
    {{-- <div class="d-flex justify-content-end"> 
        {{ $posts->links() }} {{-- Pagination dimunculkan disini default menggunakan tailwind, untuk mengganti ke bootstrap, ke App\Providers\AppServiceProvider baca dokumentasi ada yg di tambahkan--}}
    </div> --}}
@endsection
